...
// ── Unified Pastel Color System ────────────────────────────────
// Single source of truth for all screens: dashboard, analytics, create-habit, etc.
...
// ── Primary dark CTA token ────────────────────────────────────
// Used consistently on ALL primary action buttons across every screen.
