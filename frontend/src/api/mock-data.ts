...
function buildCueContext(habit: Habit) {
  return habit.cues.map((cue) => ({
    ...
    locationLat: cue.locationLat,
    locationLng: cue.locationLng,
...
export const reminders: Reminder[] = [
  ...
  },
  {
    ...
    explanation: { isScheduledToday: true, activeCueCount: 0 },
  ...
  },
  {
    ...
    explanation: { isScheduledToday: false, activeCueCount: 1 },
