...
export const HABIT_TEMPLATE_CATEGORIES: HabitTemplateCategoryMeta[] = [
  {
    id: 'health',
    label: 'Эрүүл мэнд',
    description: 'Хичээл, ажил ихтэй өдөр ч биеэ анзаарах жижиг дадлууд',
  },
  {
    id: 'productivity',
    label: 'Бүтээлч байдал',
    description: 'Цагаа зөв ашиглаж, өдөр тутмын замбараагаа олох',
  },
  {
    id: 'learning',
    label: 'Суралцах',
    description: 'Шалгалт, даалгавар, шинэ мэдлэгт бага багаар ахих',
  },
  {
    id: 'mindfulness',
    label: 'Сэтгэлгээ',
    description: 'Стрессээ бууруулж, анхаарал болон сэтгэлээ тогтворжуулах',
  },
];
...
export const HABIT_TEMPLATES: HabitTemplate[] = [
  ...
  },
  {
    ...
    benefits: ['Тайвшруулах', 'Эрч хүч нэмэх'],
    steps: ['Утсаа цэнэглэгч дээр хол тавих', 'Гэрлээ бүдгэрүүлэх', 'Орондоо орох'],
    selectedDays: ALL_WEEKDAYS,
    habitType: 'binary',
    targetNum: '1',
    targetUnit: 'удаа',
  ...
  // ── Бүтээлч байдал ──────────────────────────────────────────────────────
  {
    ...
    title: 'өдрийн төлөвлөгөө гаргах',
    selectedEmoji: '✍️',
    colorId: 'yellow',
...

  {
    ...
    benefits: ['Бүтээмж нэмэх', 'Анхаарал төвлөрүүлэх'],
    steps: ['Даалгаврын жагсаалтаа харах', 'Хамгийн жижиг алхмыг сонгох', '10 минут эхлүүлж хийх'],
    selectedDays: WEEKDAYS_MON_FRI,
    habitType: 'measurable',
    targetNum: '10',
    targetUnit: 'мин',
  ...
  },
  {
    id: 'gratitude',
    category: 'mindfulness',
    tagline: 'Өдрийн төгсгөлд 3 сайн зүйлээ бичих',
  ...
  },
  {
    ...
    benefits: ['Тайвшруулах', 'Анхаарал төвлөрүүлэх'],
    steps: ['Утсаа цэнэглэгч дээр хол тавих', 'Дэлгэцгүй 30 минут өнгөрөөх', 'Орондоо тайван орох'],
    selectedDays: ALL_WEEKDAYS,
    habitType: 'measurable',
    targetNum: '30',
    targetUnit: 'мин',
