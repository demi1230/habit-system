...
const SLIDES: Slide[] = [
  ...
  },
  {
    ...
    body: 'Бидний амьдралын ихэнх үр дүн (эрүүл мэнд, суралцах чадвар, бүтээмж) нэг удаагийн том шийдвэрээс биш, харин өдөр бүр давтагддаг жижиг дадлуудаас шалтгаалдаг. Дадал, зуршлын талаар судалсныхаа дараа үүнийг илүү тод ойлгосон. Том өөрчлөлтүүд гэнэт биш, жижиг үйлдлүүдийг тогтмол давтах үед бий болдог.',
  },
  {
    Icon: Bell,
    title: 'Дадал хэрхэн үүсдэг вэ?',
    body: 'Бидний тархи давтагдсан үйлдлийг аажмаар автомат болгодог. Жишээ нь, өглөө сэрээд утсаа шууд шалгах, эсвэл орой ядрах үед сошиал үзэх. Эдгээрийг бид анзаарахгүйгээр давтсаар байгаад дадал болгочихдог. Учир нь тархи амар, таатай зүйлсийг л давтан хийж, харин илүү их хүчин чармайлт шаардсан зүйлсээс зайлсхийх хандлагатай байдаг. Гэхдээ энэ онцлогийг зөв ашиглавал өөрийнхөө амьдралыг хүссэн чиглэл рүү бага багаар зүглүүлж чадна.',
  },
  {
    Icon: Rocket,
    title: 'Эхний дадлаа үүсгэцгээе',
    body: 'Энэ апп чамд хэрэгтэй дадлыг аажмаар, тогтвортой бий болгох зорилготой. Өдөр бүр бага багаар. Хамтдаа илүү сайн хувилбар руугаа ойртъё.',
  },
];
