...
Энэ бүлэгт өмнөх бүлгүүдэд тодорхойлсон шаардлага, архитектур, өгөгдлийн загварт тулгуурлан боловсруулсан туршилтын загварын хэрэгжүүлэлтийг тайлбарлана. Тодруулбал, системийг хэрэгжүүлэхэд ашигласан технологийн стек, кодын сангийн бүтэц, өгөгдлийн сангийн хэрэгжилт, домайн логикийн гол дүрмүүд, бэкэнд болон фронтэндийн үндсэн модулиуд, API-ийн зохион байгуулалт, мөн функциональ шаардлагын хэрэгжилтийн байдлыг авч үзнэ.

Энэхүү бүлгийг 12 дугаар долоо хоногийн урьдчилсан хамгаалалтын түвшинд, өөрөөр хэлбэл системийн үндсэн цөм боломжууд хэрэгжиж, прототип хувилбар турших боломжтой болсон байдлыг тусган боловсруулав. Иймээс уг бүлэгт хэрэгжсэн хэсгүүдийг төв болгон тайлбарлаж, бүрэн гүйцэд болоогүй боломжуудыг мөн ялган дурдсан болно.

\section{Технологийн стек}

Туршилтын загварын хэрэгжүүлэлтэд ашигласан үндсэн технологиуд:
...
\begin{itemize}
  ...
  \item \textbf{UI:} Tailwind CSS + shadcn/ui --- хурдан прототип болон тогтвортой интерфэйсийн хэв маяг.
...
frontend/src/
  ...
  lib/            -- i18n, theme, utility функцууд
...
Нийт 13 үндсэн хүснэгтийг хэрэгжүүлсэн бөгөөд тэдгээрийн зорилгыг Хүснэгт~\ref{tab:db-tables}-д нэгтгэн үзүүлэв.
...
\texttt{AdaptationRules} нь гүйцэтгэлийн хувь, сануулгаас хамааралтай байдал, өөрийн санаачилгатай гүйцэтгэл, дадлын хүчний оноо, сүүлийн төвөгшлийн үнэлгээ зэрэг үзүүлэлтүүдэд үндэслэн зөвлөмж гаргана. Туршилтын загварын түвшинд дараах үндсэн анхаарлын чиглэлүүдийг тодорхойлсон.
...
Сануулгад хэрэглэгч \texttt{DONE} эсвэл \texttt{SNOOZE} гэсэн хоёр үндсэн үйлдэл өгөх боломжтой. \texttt{DONE} тохиолдолд холбогдох гүйцэтгэлийн бүртгэл автоматаар үүсч, trigger source нь сануулгад тулгуурласан гэж тэмдэглэгдэнэ. \texttt{SNOOZE} тохиолдолд дахин сануулах хугацааг бүртгэнэ.
...
Dashboard & Өдрийн идэвхтэй дадлуудын жагсаалт, хурдан бүртгэл, товч ахицын мэдээлэл \\ \hline
HabitDetail & Дадлын дэлгэрэнгүй, 28 хоногийн түүх, дадлын хүчний мэдээлэл, cue болон хуваарь \\ \hline
CreateHabit & Дадал үүсгэх форм, хэмжилт, хуваарь, cue, шалтгаан, сануулгын тохиргоо \\ \hline
Reminders & Сануулгын жагсаалт, тайлбар, DONE/SNOOZE үйлдэл \\ \hline
Analytics & Ахицын шинжилгээ, heatmap, харьцуулсан үзүүлэлтүүд \\ \hline
Auth & Бүртгэл болон нэвтрэх дэлгэц \\ \hline
Profile & Хэл, theme болон хэрэглэгчийн ерөнхий тохиргоо \\ \hline
...
Хэрэглэгч мэдээллээ оруулах үед дэлгэц дээр урьдчилсан ойлгомжтой харагдац үзүүлэхээр төлөвлөсөн. Гэвч 12 дугаар долоо хоногийн түвшинд энэхүү өгүүлбэрэн урьдчилсан харагдац нь бүтэн автомат генераци хэлбэрээр бус, интерфэйсийн хязгаарлагдмал харагдацын түвшинд хэрэгжсэн.

Дадал үүсгэх формын хоёр үндсэн хэсгийг Зураг~\ref{fig:addhabit}-д харуулав. Зүүн дэлгэц нь дадлын нэр, харагдах төрх, ашиг тус болон хуваарийн тохиргоог агуулж, баруун дэлгэцэд сануулгын идэвхжүүлэлт болон хэмжилтийн нарийвчлалтай тохиргоог харуулсан.
...
Фронтэнд талын \texttt{api/client.ts} нь суурь HTTP клиентийг агуулж, хэрэглэгчийн JWT токеныг Authorization header-д автоматаар хавсаргана. Хэрэв 401 алдаа ирвэл хэрэглэгчийг дахин нэвтрэх урсгал руу шилжүүлдэг. Мөн хөгжүүлэлтийн зарим үе шатанд mock mode ашиглан интерфэйсийг бэкэндээс хэсэгчлэн хамааралгүй турших боломж бүрдүүлсэн.

\subsection{Олон хэлний дэмжлэг}

Интерфэйсэд монгол болон англи хэлний суурь дэмжлэгийг нэвтрүүлсэн. Хэрэглэгчийн сонгосон хэлийг profile хэсгээс өөрчлөх боломжтой бөгөөд тухайн сонголтыг localStorage-д хадгалж, дараагийн удаа апп нээхэд сэргээдэг.

\section{API-ийн нэгдсэн тойм}

Системийн бэкэнд нь RESTful зарчмаар зохион байгуулагдсан. Үндсэн endpoint-уудыг Хүснэгт~\ref{tab:api-overview}-д нэгтгэн үзүүлэв.
...
Энэ бүлэгт зан үйлд суурилсан дадал хэвшүүлэх системийн туршилтын загварын бодит хэрэгжүүлэлтийг тайлбарлав. Үүнд технологийн стек, кодын сангийн бүтэц, өгөгдлийн сангийн хэрэгжилт, сануулгын шийдвэрийн дүрэм, дадлын хүчний тооцоолол, дасан зохицох зөвлөмж, бэкэнд болон фронтэндийн үндсэн модулиуд, API-ийн зохион байгуулалт, мөн функциональ шаардлагын хэрэгжилтийн байдал зэргийг авч үзлээ.

Хэрэгжүүлэлтийн үр дүнд дадал үүсгэх, гүйцэтгэл бүртгэх, сануулга шийдвэрлэх, SRBAI үнэлгээ авах, дадлын хүч тооцоолох, ахицын мэдээлэл боловсруулах зэрэг цөм боломжууд ажиллах түвшинд хүрсэн. Мөн системийн зан үйлийн дэмжлэгийн гол логик болох \texttt{ReminderDecisionRules}, \texttt{HabitStrengthRules}, \texttt{AdaptationRules} дүрмүүдийг кодын түвшинд хэрэгжүүлснээр өмнөх бүлгүүдэд боловсруулсан онолын загварыг програм хангамжийн туршилтын шийдэл болгон буулгах боломжтойг харуулсан.
